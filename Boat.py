...
class Boat:
    ...
    def draw(self):
        if self.mx >= monitor_width / 2:
            self.image.clip_draw(400 * self.frame, 0, 400, 400, self.boat_x, self.boat_y, 200, 200)
        else:
            self.image.clip_composite_draw(400 * self.frame, 0, 400, 400, 0, 'h', self.boat_x, self.boat_y, 200, 200)
